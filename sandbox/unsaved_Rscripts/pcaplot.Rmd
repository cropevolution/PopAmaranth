...
# cores<-c(rep('blue', 18), rep('red', 28), rep('green', 12), rep('orange', 9))
# 
# 
#   ev <- eigen(covaraiants)
#   
# experimentando_covaraiantes<-  cbind(species, covaraiants)  
# ggplot(covaraiants, aes(x=V1, y=V2))+
#   geom_point(aes(color=factor(species)))
# 
# plot(ev)
# 
# plot(covaraiants$V1, covaraiants$V2, )
# 
